Shader "Custom/Fx/DistortaddMask" {
Properties {
...
fixed4 frag( v2f i ) : COLOR
{
    ...
    fixed2 UV_Dis = i.uvmain;
	UV_Dis.x += ((offsetColor1.r + offsetColor2.r) - 1) * _ForceX;
	UV_Dis.y += ((offsetColor1.r + offsetColor2.r) - 1) * _ForceY;
	return 2.0f * i.color * _TintColor * tex2D( _MainTex, UV_Dis) * tex2D( _MaskTex, i.uvmain).a;
}
ENDCG
		}
}
