Shader "Custom/Scene/Water2UV" {
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutput o) {
			half4 DisTex = tex2D (_WaterTex, IN.uv2_WaterTex + float2(_SpeedU , _SpeedV) * _Time.y); 
			...
			half4 SplTex = tex2D (_WaterTex, IN.uv2_WaterTex + 0.3 * DisTex);
