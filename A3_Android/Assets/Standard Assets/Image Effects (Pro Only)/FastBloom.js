...
class FastBloom extends PostEffectsBase {
	...
	static public var FAST_BLOOMSHADER : Shader = null;
	private var fastBloomMaterial : Material = null;
	
	function CheckResources () : boolean {	
		if( FAST_BLOOMSHADER == null ){
			isSupported = false;
			enabled = false;
			return false;
		}
		...
		fastBloomMaterial = CheckShaderAndCreateMaterial (FAST_BLOOMSHADER, fastBloomMaterial);
