...
class DepthOfField34 extends PostEffectsBase {
	...
	static public var DOF_BLUR_SHADER : Shader;
	private var dofBlurMaterial : Material = null;	
	
	static public var DOF_SHADER : Shader;
    ...
    static public var BOKEN_SHADER : Shader;
	...
	function CreateMaterials () {
		if( DOF_BLUR_SHADER == null || DOF_SHADER == null || BOKEN_SHADER == null ){
			isSupported = false;
			enabled = false;
			return;
		}
				
		dofBlurMaterial = CheckShaderAndCreateMaterial (DOF_BLUR_SHADER, dofBlurMaterial);
		dofMaterial = CheckShaderAndCreateMaterial (DOF_SHADER,dofMaterial);  
		bokehSupport = BOKEN_SHADER.isSupported;     

		if(bokeh && bokehSupport && BOKEN_SHADER) 
			bokehMaterial = CheckShaderAndCreateMaterial (BOKEN_SHADER, bokehMaterial);
	}
