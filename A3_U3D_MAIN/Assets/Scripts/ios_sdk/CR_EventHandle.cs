...
public class CR_EventHandle : MonoBehaviour
{
    ...
    public static extern void AppsFlyerLogin(string zoneId, string cId , string roleName, string roleLevel, string zoneName, string chargeSuccess);   
    ...
    static public CR_EventHandle _instance = null;
