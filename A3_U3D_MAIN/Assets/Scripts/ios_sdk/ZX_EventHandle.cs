...
public class  ZX_EventHandle : MonoBehaviour
{
    ...
    [DllImportAttribute("__Internal")]
    public static extern void AppStoreBuy(string desc,string price, string roleid, string cp_trade_no, string serverid, string waresId,
      string waresName, string cpPrivateInfo);


    //end

    static public ZX_EventHandle _instance = null;
    ...
    {
        AppStoreBuy(m_buy_date["productDesc"]._str,
            m_buy_date["productPrice"]._str,
