...
public class JX_EventHandle : MonoBehaviour
{
    ...
    public static extern void AppStoreBuy(string price, string roleid, string cp_trade_no, string serverid, string waresId,
        string waresName, string cpPrivateInfo, string desc, string servername, string rolename, string rolelv, string homename, string transparent);

    [DllImportAttribute("__Internal")] //登录 上报
    public static extern void AppsFlyerLogin(string zoneId, string cId, string roleName, string roleLevel, string zoneName, 
        string homename, string chargeSuccess, string lveleUpTime);

    [DllImportAttribute("__Internal")] //创角 上报
    public static extern void AppsFlyerCreateRole(string zoneId, string cId, string roleName, string roleLevel, string zoneName,
       string homename, string chargeSuccess, string lveleUpTime);

    [DllImportAttribute("__Internal")] //退出 上报
    public static extern void AppsFlyerLoginOut(string zoneId, string cId, string roleName, string roleLevel, string zoneName,
       string homename, string chargeSuccess, string lveleUpTime);

    [DllImportAttribute("__Internal")] //升级 上报
    public static extern void AppsFlyerLevelUp(string zoneId, string cId, string roleName, string roleLevel, string zoneName,
       string homename, string chargeSuccess, string lveleUpTime);

    [DllImportAttribute("__Internal")] //选服 上报
    public static extern void AppsFlyerChooseServer(string zoneId, string cId, string roleName, string roleLevel, string zoneName,
     string homename, string chargeSuccess, string lveleUpTime);
    ...
    static public JX_EventHandle _instance = null;
    ...
    public void sdk_enterGame(Variant v)
    {
        ...
        AppsFlyerChooseServer(v["roleServerId"]._str,
           v["roleId"]._str,
           v["roleName"]._str,
           v["roleLevel"]._str,
           v["roleServerName"]._str,
