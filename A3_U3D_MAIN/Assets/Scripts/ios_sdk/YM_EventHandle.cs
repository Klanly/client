...
public class YM_EventHandle : MonoBehaviour
{
    ...
    public static extern void AppStoreBuy(string price, string roleid, string cp_trade_no, string serverid, string waresId,
        string waresName, string cpPrivateInfo, string desc, string puid, string ymOrderId);

    [DllImportAttribute("__Internal")] //创角 上报
    public static extern void AppsFlyerCreateRole(string zoneId, string cId, string roleName, string roleLevel, string zoneName, string puid, string entertime);

    [DllImportAttribute("__Internal")] //升级 上报
    public static extern void AppsFlyerLevelUp(string zoneId, string cId, string roleName, string roleLevel, string zoneName, string puid, string entertime);


    [DllImportAttribute("__Internal")] //登录 上报
    public static extern void AppsFlyerLogin(string zoneId, string cId , string roleName, string roleLevel, string zoneName, string puid, string entertime);   
    ...
    static public YM_EventHandle _instance = null;
