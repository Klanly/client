...
public class  ML_EventHandle : MonoBehaviour
{
    ...
    [DllImportAttribute("__Internal")]
    public static extern void AppStoreBuy(string price, string serverid, string cp_trade_no, string servername, string waresId,
        string waresName, string cpPrivateInfo, string desc);       


    //end

    static public ML_EventHandle _instance = null;
