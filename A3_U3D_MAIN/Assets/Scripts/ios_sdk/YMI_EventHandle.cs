...
public class YMI_EventHandle : MonoBehaviour
{
    ...
    [DllImportAttribute("__Internal")]
    public static extern void AppStoreBuy(string price, string rolename, string cp_trade_no, string servername, string waresId,
        string waresName, string cpPrivateInfo, string desc);       


    //end

    static public YMI_EventHandle _instance = null;
