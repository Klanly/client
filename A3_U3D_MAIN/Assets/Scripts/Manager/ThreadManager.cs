    ...
    public class ThreadManager : View {
        ...
        void OnDownloadFile(List<object> evParams) {
            ...
            using (WebClient client = new WebClient()) {
                ...
                client.DownloadFileCompleted += new System.ComponentModel.AsyncCompletedEventHandler(com);
                client.DownloadFileAsync(new System.Uri(url), currDownFile);
               
            }
        }

        void com(object sender, System.ComponentModel.AsyncCompletedEventArgs e)
        {
            if (e.Error != null)
            {
                NotiData data = new NotiData(NotiConst.UPDATE_ERROR, e.Error.ToString());
