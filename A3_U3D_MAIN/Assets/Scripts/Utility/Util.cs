    ...
    public class Util
    {
        ...
        public static string DataPath
        {
            get
            {
                ...
                if (Main.instance == null || Main.instance.debugMode == Main.ENUM_DEBUG_STATE.local_resource_debug)
                {
        ...
        public static string LuaPath(string name)
        {
            ...
            if (luaPaths.Count == 0)
            {
                ...
                if (Application.platform == RuntimePlatform.IPhonePlayer)
                {
                    AddLuaPath("file://" + Application.dataPath + "/Raw/lua/");
                }
                else if (Application.platform == RuntimePlatform.Android)
                {
                    AddLuaPath("jar:file://" + Application.dataPath + "/!/assets/lua/");
                }
                else
                {
                    AddLuaPath(Application.dataPath + "/" + AppConst.AssetDirname + "/lua/");
        ...
        public static string SearchLuaPath(string fileName)
        {
            ...
            //   Debug.Log("nofile::"+ fileName);

            return luaPaths[1] + fileName;
        }
        ...
        public static bool CheckEnvironment()
        {
            ...
            if (Application.loadedLevelName == "Test" && Main.instance.debugMode == Main.ENUM_DEBUG_STATE.none_debug)
            {
        ...
        public static void CopyDirectory(string sourcePath, string destinationPath, string filter = "", string unFilter = "")
        {
            ...
            foreach (FileSystemInfo fsi in info.GetFileSystemInfos())
            {
                ...
                {
                    if (unFilter != "" && fsi.FullName.EndsWith(unFilter))
                        continue;
