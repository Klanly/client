...
public class LuaScriptMgr
{
    ...
    public void Start()
    {
        ...
        foreach (Type t in checkBaseType) {
           debug.Log("BaseType {0} not register to lua："+ t.FullName);
        }
    ...
    void OnBundleLoaded()
    {
        ...
        //#endif
        UnityEngine.Debug.Log("run lua file System.Global");
        ...
        UnityEngine.Debug.Log("run lua file System.Main");
        DoFile("System.Main");
    ...
    public byte[] Loader(string name)
    {
        ...
        //   if (File.Exists(path))
        {
            ...
            if (Application.isMobilePlatform)
            {
                ...
                if (www.error != null)
                {
                    ...
                    UnityEngine.Debug.Log("----->error::" + www.error.ToString());
        ...
        debug.Log("----->Loader::" + path+" "+ File.Exists(path));

        lua_file_num++;
        UpdateScrollbar.SetShow_Txt(OutGameContMgr.getOutGameCont("loadlua",lua_file_num.ToString()));
#else
