...
public class SimpleFramework_UtilWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("sizeFile", sizeFile),
			...
			new LuaMethod("isInPhone", isInPhone),
			...
			new LuaMethod("del", del),
			new LuaMethod("DeleteFolder", DeleteFolder),
			new LuaMethod("MoveDirectory", MoveDirectory),
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int sizeFile(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		string arg0 = LuaScriptMgr.GetLuaString(L, 1);
		long o = SimpleFramework.Util.sizeFile(arg0);
		LuaScriptMgr.Push(L, o);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int isInPhone(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 0);
		bool o = SimpleFramework.Util.isInPhone();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int del(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		string arg0 = LuaScriptMgr.GetLuaString(L, 1);
		SimpleFramework.Util.del(arg0);
		return 0;
	}
	...
	static int DeleteFolder(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		string arg0 = LuaScriptMgr.GetLuaString(L, 1);
		SimpleFramework.Util.DeleteFolder(arg0);
		return 0;
	}
	...
	static int MoveDirectory(IntPtr L)
	{
		...
		string arg0 = LuaScriptMgr.GetLuaString(L, 1);
		string arg1 = LuaScriptMgr.GetLuaString(L, 2);
		SimpleFramework.Util.MoveDirectory(arg0,arg1);
		return 0;
	}
	...
	static int CopyDirectory(IntPtr L)
	{
		...
		SimpleFramework.Util.CopyDirectory(arg0,arg1,arg2,arg3);
		return 0;
	}
}
