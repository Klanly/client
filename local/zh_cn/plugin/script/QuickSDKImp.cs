...
namespace quicksdk
{
	...
	public enum FuncType 
	{
		...
		QUICK_SDK_FUNC_TYPE_REAL_NAME_REGISTER = 105,/*实名认证 （android）*/
...
//            androidSupport.init();
		...
		public void wxShare(Hashtable shareInfoMap,Boolean isFriendCircle)
		{
			#if UNITY_ANDROID && !UNITY_EDITOR
			QuickUnitySupportAndroid androidSupport = QuickUnitySupportAndroid.getInstance();
			androidSupport.wxShare(shareInfoMap,isFriendCircle);
			#endif
			
		}

		public void weiboShare(Hashtable shareInfoMap)
		{
			#if UNITY_ANDROID && !UNITY_EDITOR
			QuickUnitySupportAndroid androidSupport = QuickUnitySupportAndroid.getInstance();
			androidSupport.weiboShare(shareInfoMap);
			#endif
		...
		{
			#if UNITY_IOS && !UNITY_EDITOR
			quicksdk_nativeUpdateRoleInfoWith(gameRoleInfo.serverID, gameRoleInfo.serverName, gameRoleInfo.gameRoleName, gameRoleInfo.gameRoleID, gameRoleInfo.gameRoleBalance, gameRoleInfo.vipLevel, gameRoleInfo.gameRoleLevel, gameRoleInfo.partyName);
			#elif UNITY_ANDROID && !UNITY_EDITOR
			QuickUnitySupportAndroid androidSupport = QuickUnitySupportAndroid.getInstance();
		...
		[DllImport("__Internal")]
		private static extern void quicksdk_nativeUpdateRoleInfoWith(string serverId, string serverName, string gameRoleName, string gameRoleId, string gameRoleBalance, string vipLevel, string gameRoleLevel, string partyName);
		[DllImport("__Internal")]
...
//            ao.Call("requestInit");
		...
		public void wxShare(Hashtable ht,Boolean isFriendCircle)
		{
			string json="{";
			...
			Debug.Log("测试 " + json);
			ao.Call("wxShare",json,isFriendCircle+"");
		}

		public void weiboShare(Hashtable ht)
		{
			string json="{";
